...
type pairs the channel with a [`"locus"`](scale.md#locus-scale)
...
!!! note "What happens under the hood"
    ...
    [linearizeGenomicCoordinate](transform/linearize-genomic-coordinate.md)
...
GenomeSpy's [`"locus"`](scale.md#locus-scale) scale expects
