 ...
 * @returns {string}
 */
export function renderGeneratedActionSummaries(generatedActionSummaries) {
    return `// @ts-check
...
export const generatedActionSummaries = ${JSON.stringify(
...
export async function writeGeneratedActionSummaries() {
    ...
    const output = renderGeneratedActionSummaries(generatedActionSummaries);
