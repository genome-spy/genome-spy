...
function buildEntry(actionType, node, payloadTypeDocs) {
    ...
    const payloadType = agentTags.payloadType || inferPayloadType(actionType);
...
export async function createGeneratedActionCatalog() {
    ...
    for (const actionType of actionTypes) {
        const reducerNode = reducerNodes.get(actionType);
        if (!reducerNode) {
 ...
 * @returns {string}
 */
export function renderGeneratedActionCatalog(generatedActionCatalog) {
    return `// @ts-check
/* This file is generated by scripts/generateAgentActionCatalog.mjs. Do not edit manually. */

/** @type {import("./types.js").AgentActionCatalogEntry[]} */
export const generatedActionCatalog = ${JSON.stringify(
...
export async function writeGeneratedActionCatalog() {
    ...
    const output = renderGeneratedActionCatalog(generatedActionCatalog);
