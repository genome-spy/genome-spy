...
import { isConcatSpec, isLayerSpec, isUnitSpec } from "./viewSpecGuards.js";
                        ...
                        this.context.createOrImportView(
                            ...
                            (importedSpec) => {
                                if (
                                    ...
                                    !isConcatSpec(importedSpec)
                                ) {
                                    throw new ViewError(
                                        "LayerView accepts only unit, layer, concat, or multiscale specs as children!",
                                        this
                                    );
