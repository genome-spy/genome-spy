...
/**
 * @typedef {object} KeyedLookupOptions
...
/**
 * Base class for transforms that perform an exact keyed lookup from a
 * collected side input. Subclasses may supply domain-specific readiness and
 * filtering.
 */
export default class KeyedLookupTransform extends Transform {
    get behavior() {
     ...
     * @param {KeyedLookupOptions} [options]
     */
