...
export function resolveTextProperties(mark) {
    ...
    return {
        ...
        flushX: resolveMarkProperty(mark, props.flushX),
        flushY: resolveMarkProperty(mark, props.flushY),
        squeeze: resolveMarkProperty(mark, props.squeeze),
        dx: resolveMarkProperty(mark, props.dx),
        dy: resolveMarkProperty(mark, props.dy),
    };
}
