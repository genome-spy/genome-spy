...
The likely identity ingredients are view identity, facet or repetition identity,
and a small explicit rendering/layout role. Exact key and storage types should
be selected only after Phase 1 reveals the simplest layout-result shape.
